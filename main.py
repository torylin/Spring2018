...
query_cols = []
query_values = ['2000', '2001', '2002'] #Change to be the value(s) you're querying in the column you've specified
...
def index():
    ...
    res = get_all_data(make_query([], query_values, 200)) #5 is our limit we're passing in
